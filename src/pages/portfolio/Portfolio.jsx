    ...
    <div className="text-gray-900">
      ...
      <div className="flex justify-center space-x-4 py-8">
        {tabs.map((tab) => (
          <button
            key={tab}
            className={`px-5 py-2 text-lg rounded-full ${
              activeTab === tab
          ...
          {filteredProjects.map((project) => (
            ...
            >
              ...
              <p className="text-gray-600 mt-2">
                A brief overview of the project, highlighting key features.
              </p>
      ...
      <section className="px-6 md:px-16 py-16 bg-gray-100">
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-10">
          {caseStudies.map((caseStudy) => (
            <div
              key={caseStudy.id}
              className="flex items-center gap-6 bg-white shadow-lg p-6 rounded-xl"
              data-aos="fade-up"
            >
              <img
                src={caseStudy.img}
