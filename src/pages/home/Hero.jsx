...
const HeroSection = () => {
  return (
    <div className="mt-[8rem] mb-18 grid grid-cols-1 md:grid-cols-1 md:text-center lg:text-start lg:grid-cols-2 items-center padded ">
      <div className="">
        <h2 className="leading-14 mb-4 font-bold text-gray-700 text-5xl md:text-5xl  ">
        ...
        <div className="flex gap-4 mt-8 lg:justify-start md:justify-center ">
          <Button
            text="Learn more"
            to="/about"
            className="px-8 py-4"
      ...
      <div className="justify-center items-center hidden md: lg:flex ">
